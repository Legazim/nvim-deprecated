...
-- Make <Tab> accept selected completion item or notify coc.nvim to format
...
keyset("n", "<M-s>", "<Plug>(coc-range-select)", {silent = true})
keyset("x", "<M-s>", "<Plug>(coc-range-select)", {silent = true})
